...
/* harmony import */ var _clearState__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./clearState */ "./src/js/modules/clearState.js");
  ...
  allForms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        clearInputs();
        Object(_clearState__WEBPACK_IMPORTED_MODULE_6__["default"])(state);
        setTimeout(function () {
